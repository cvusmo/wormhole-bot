...
// TODO:
// ADD: cooldown for !rss
// ADD: !someName command for pausing
// ADD: Replace plaintext with Embed support (CreateEmbed)
// ADD: LOGGING, log to file for println! and errors
// ADD: Multiple interval settings, various checks for various feeds
// ADD: Multiple channels + multiple RSS feeds going to those channels
//      - store collection of feed URLs and channel IDs
//      - Update Handler to iterate over feeds and post in appropriate channels
//      - Load feed configs from .secrets file or a config file?
